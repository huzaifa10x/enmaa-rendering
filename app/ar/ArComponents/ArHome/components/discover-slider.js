...
export default function DiscoverSlider() {
    ...
    // Let the browser paint the LCP element before autoplay starts.
    useEffect(() => {
    ...
    return (
        <div ref={sectionRef} className="relative h-screen w-full overflow-hidden bg-black">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-evenly z-20">
                ...
                <div
                    className={`text-center transition-all duration-300 ease-out ${textFadeClass}`}
                >
                    <p className="text-5xl md:text-6xl lg:text-9xl text-white font-black mb-4 tracking-tight block">
